...
define("Utils",function(){return{elements:{},getEl:function(a){if(typeof a==="string"){if(this.elements[a]){return this.elements[a]}else{this.elements[a]=document.getElementById(a);return this.elements[a]}}else{return a}},clone:function(d){var b={},c=null;for(c in d){if(d.hasOwnProperty(c)){b[c]=d[c]}}return b},extend:function(d,a){var c=null;if(!d){d={}}for(c in a){try{if(a[c].constructor===Object){d[c]=this.extend(d[c],a[c])}else{d[c]=a[c]}}catch(b){d[c]=a[c]}}return d},create:function(d,b){var c=this;if(arguments.length>1){b=this.extend(this.clone(d),b);b.superclass=d}else{b=d}function a(f,e){this.el=c.getEl(f);this.options=c.extend(this.options,e);if(this.init){this.init()}}a.prototype=b;return a}}});
define("Child",function(){return{childfunc:function(){console.log("Child",this)},childfunc2:function(){console.log("Child2",this)}}});
define("Carousel",["Utils","Child"],function(b,a){return b.create(a,{init:function(){},carouselfunc:function(){console.log("Carouselfunc",this)}})});